                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumb-content">
                            <h1 class="breadcrumb-hrading">Sub Category</h1>
                                        ...
                                        while ($show = mysqli_fetch_array($query)) {
                                            ...
                                            <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6 col-xs-12">
                                                <article class="list-product">
                                                    <div class="img-block">
                                                        <a href="subcategory_wise.php?name=<?php echo $show['name']; ?>&amp;category=<?php echo $show11['name']; ?>"
                                                            class="thumbnail">
                                                    ...
                                                    <div class="product-decs">
                                                        <h2><a href="subcategory_wise.php?name=<?php echo $show['name']; ?>&amp; category=<?php echo $show11['name']; ?>"
