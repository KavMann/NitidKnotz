    ...
    <body>
        ...
        <div id="main">
		   ...
		   while($show=mysqli_fetch_array($query))
		   {
			   $i++;
			  ?>
                    <div class="slider-height-6 d-flex align-items-start justify-content-start bg-img" style="background-image: url(<?php echo $show['image']?>);">
                        <div class="container">
                            <div class="slider-content-1 slider-animated-1 text-left">
                                
                                <h1 style="color: navy;font-size: 70px; font-family: 'Allura', cursive; padding-left: 30px; text-shadow: -2px 0px 0px white, 2px 0px 0px white, 0px -2px 0px white, 0px 2px 0px white;" class="animated">
                                    <?php echo $show['heading']?>
                                </h1>
                                <p style="color: black; font-family: 'Tangerine', cursive; font-size: 43px; padding-left: 253px; text-shadow: -1px 0px 3px white, 1px 0px 3px white, 0px -1px 3px white, 0px 1px 3px white;" class="animated">
                                    <?php echo $show['descr'];  ?></p>
            ...
            onmouseout="this.src='images/thumb-5.png'" />
                                        ...
                                        <div class="desc-listcategoreis">
                                            ...
                                            <span class="number_product"><?php echo $number1; ?> Products</span>
                                            <a href="category_wise.php?name=<?php echo $show['name']; ?>"> Shop Now <i class="ion-android-arrow-dropright-circle"></i></a>
                                        </div>
                                    </div>
							  </div>
                           <?php }?>
            ...
            onmouseout="this.src='images/thumb-5.png'" />
                                        ...
                                        <div class="desc-listcategoreis">
                                            ...
                                            <span class="number_product"><?php echo $number1; ?> Products</span>
                                            <a href="embroideryshop.php?name=<?php echo $show['name']; ?>"> Shop Now <i class="ion-android-arrow-dropright-circle"></i></a>
                                        </div>
                                    </div>
							  </div>
                           <?php }?>
     ...
     onmouseout="this.src='<?php echo $show['image']?>'" />
                            ...
                            <div class="product-decs">
                                ...
                                <h2><a href="single-product.php?id=<?php echo $show['id']; ?>" class="product-link"><?php echo $show['name'];  ?></a></h2>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- Section Title -->
                                    <div class="section-title">
                                        <h2>Customer Reviews <a href="addreview.php"><button style="font-size: 12px;background-color: #4fb68d;border-radius: 5px;margin-left: 15px;font-weight: bold;padding-top: 3px;border: solid 1px black;color: white;padding-bottom: 3px;"> Add Review </button></a></h2>
                                    </div>
                                    <!-- Section Title End-->
                                </div>
                            </div>
                                ...
                                <article class="list-product">
                                    <div class="img-block">
                                        <a style="margin-top:20px;display:inline-block;" class="thumbnail">
                                            <img class="first-img"  src="<?php echo $show['image']?>" style="height: 235px;margin: auto;width: 235px;padding: 5px;/* width: 74%; */border-radius: 50%;border: solid 1px black;" alt="" />
                                        </a>
                                    </div>
